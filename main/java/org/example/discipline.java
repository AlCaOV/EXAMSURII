    ...
    public void listdiscipline( ){
        ...
        try {
            ...
            for (Iterator iterator = Disciplines.iterator(); iterator.hasNext();){
                ...
                System.out.println("Group number: " + discipline.getLgroup());
                System.out.println("Faculty Number: " + discipline.getfaculty_number());
                System.out.println("Discipline grade: " + discipline.getgrade_in_discipline());
                System.out.println("Course: " + discipline.getCourse());
            }
            tx.commit();
        } catch (HibernateException e) {
            if (tx!=null) tx.rollback();
